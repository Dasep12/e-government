...
<head>
  ...
  <title>Administrator | E-Government</title>
...
<!-- DataTables -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/client/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?= base_url() ?>assets/client/index2.html" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?= base_url() ?>assets/client/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?= base_url() ?>assets/client/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="<?= base_url('administrator/Data_pencaker') ?>">
            <i class="fa fa-users"></i> <span>Pencari Kerja</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('administrator/Tambah_jurusan') ?>"><i class="fa fa-circle-o"></i> Tambah Jurusan</a></li>
            <li><a href="<?= base_url('administrator/Lihat_jurusan') ?>"><i class="fa fa-circle-o"></i> Lihat Jurusan</a></li>
          </ul>
        </li>
      </ul>
    </section>
...
<!-- DataTables -->
<script src="<?= base_url() ?>assets/client/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?= base_url() ?>assets/client/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
